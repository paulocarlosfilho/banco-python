...
# --- CONFIGURAÇÃO DE CAMINHOS E ARQUIVOS ---s
...
def log_transacao(func):
    ...
    def envelope(*args, **kwargs):
        ...
        with open(LOG_FILE, "a") as arquivo:
            # Integra a string do saldo no log
            arquivo.write(
                f"[{data_hora}] {saldo_log}"
                f"Função '{func.__name__}' executada com argumentos {args} e {kwargs}. Retornou {resultado}\n"
            )
